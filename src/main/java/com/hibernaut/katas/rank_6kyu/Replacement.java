 ...
 *  He asks himself: What is the lowest possible value I could have got after making the replacement
 ...
 * <p>
 * Output:
 *  Return sequence with N integers — which includes the lowest possible values
 * of each sequence element, after the single replacement and sorting has been performed.
 * <p>
 * Examples:
 * <p>
 * ([1,2,3,4,5])  =>  [1,1,2,3,4]
